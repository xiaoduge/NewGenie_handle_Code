...
#define TEMP_RANGE_FORMAT     "MAX %02d MIN %02d ¡æ      "
...
#define PACK_FORMAT_CHN       "%03d Ìì  %04dÉý"
#define UV_FORMAT_CHN         "%03dÌì %04dÐ¡Ê±"
...
#define UNIT_TYPE_0 "M¦¸.cm"
#define UNIT_TYPE_1 "¦ÌS/cm"
...
void Disp_UpdateWaterQuality(float fValue)
{
	...
	if(gDisplay.bit1ScreenSaver) //ÆÁ±£Ê±²»Ë¢ÐÂË®ÖÊÖµ
	{
		return;
	}
...
void Disp_UpdateRti4Temp(int iTemp)
{
    ...
    curFont->DrawText(SHOW_WATER_TEMP_UNIT_X,SHOW_WATER_TEMP_UNIT_Y,"¡æ",gDisplay.usForColor,gDisplay.usBackColor);
...
void Disp_ClientReportEntry(APP_PACKET_CLIENT_RPT_IND_STRU *pClientRptMsg)
{
    ...
    case APP_DEV_TYPE_EXE_BOARD:
         //Disp_ClientRpt4ExeBoard(pClientRptMsg); //CanÍ¨Ñ¶Ê±Ö±½Ó½ÓÊÕÖ´ÐÐ°åµÄÊý¾Ý
         break;
   ...
   case APP_PACKET_HO_STA:
       {
           ...
           // 2018/04/09 Modify: Ö»ÓÐ±¾µØÈ¡Ë®²Å¸üÐÂÈ¡Ë®×´Ì¬
           //if ((GetRelayLogicStatus(RELAY_VALVE_1)
